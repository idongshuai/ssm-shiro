...
public class RedisUtils {
    ...
    private static RedisUtils ru = new RedisUtils();
    /**
     * 获取配置信息
     */
    public static Configuration getConfig(){
        try {
            return new PropertiesConfiguration("redis.properties");
    ...
    private RedisUtils() {
        if (pool == null) {
            ...
            pool = new JedisPool(poolConfig,host,port,timeout, pass,database);
        }
    ...
    public static RedisUtils getRu() {
        return ru;
    }

    public static void setRu(RedisUtils ru) {
        RedisUtils.ru = ru;
    }
}