    ...
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            ...
            <textarea class="layui-textarea" rows="20">
                    ...
                    上传多张图片
                    <div cyType="uploadTool" cyProps="url:'/getData/upload/',value:'/statics/img/timg.jpg,/statics/img/timg.jpg' ,name:'files[]',btnName:'上传多张图片',multiple:'true',type:'img'"></div>


                    上传单张图片
                    <div cyType="uploadTool" cyProps="url:'/getData/upload/',value:'/statics/img/timg.jpg',name:'file',btnName:'上传图片',multiple:'false'"></div>
        ...
        <div class="layui-tab-item " id="result">
                    ...
                    <div cyType="uploadTool" cyProps="url:'/getData/upload/',value:'/statics/img/timg.jpg,/statics/img/timg.jpg',name:'files[]',btnName:'上传多张图片',multiple:'true',type:'img',size:'5000'"></div>
                    ...
                    <div cyType="uploadTool" cyProps="url:'/getData/upload/',value:'/statics/img/timg.jpg',name:'file',btnName:'上传图片',multiple:'false',type:'img',size:'1000',exts:'jpg'"></div>
