...
;!function (e, t) {
    ...
    r.prompt = function (e, t) {
        ...
        //文本框
        if(1 == e.formType){
            s='<input type="text " class="layui-layer-input" value="' + (e.value || "") + '">';
        }
        //文本域
        if(2 == e.formType){
            s='<textarea class="layui-layer-input"' + a + '>' + (e.value || "") +'</textarea>';
        }
        //图片+文本域
        if(3 == e.formType){
            //先删除备注文件
            $.ajax({
                type: "post",
                url: "/getData/deleteByRelationId/promptImage",
                async: false
            });
            s =  '<div cyType="HuploadTool" id="promptImage"  cyProps="name:\'promptImage\',uuid:\'promptImage\'" ></div>' +
        ...
        return r.open(i.extend({
            ...
            yes: function (i) {
                ...
                var n = l.val();
                n.length > (e.maxlength || 500) ? r.tips("&#x6700;&#x591A;&#x8F93;&#x5165;" + (e.maxlength || 500) + "&#x4E2A;&#x5B57;&#x6570;", l, {tips: 1}) : t && t(n, i, l)
            }
        }, e))
