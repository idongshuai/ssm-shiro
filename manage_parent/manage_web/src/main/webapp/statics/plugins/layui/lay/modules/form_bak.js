  ...
  Form.prototype.render = function(type){
    var that = this, items = {
      ...
      select: function(){
        ...
        var TIPS = '请选择', CLASS = 'layui-form-select', TITLE = 'layui-select-title' ,CLOSE='clear-btn'
        ...
        ,events = function(reElem, disabled, isSearch){
          ...
          //
          //   //清空该组件数据
          //     $($(this).parent().parent().prev().find("option")[0]).attr("selected","");
          //     //渲染下拉树
  ...
  var submit = function(){
    ...
    layui.each(verifyElem, function(_, item){
      ...
      layui.each(ver, function(_, thisVer){
        ...
        if(verify[thisVer] && (isFn ? tips = verify[thisVer](value, item) : !verify[thisVer][0].test(value)) ){
            /**如果是下拉框 将object转为美化后的dom  用于验证提示  2018/6/02 **/
    ...
    if(stop) return false;
      layui.each(fieldElem, function (_, item) {
          ...
          /**解决复选框相同name只能获取最后一个值问题. by  2018/6/26*/
