    ...
    <div class="layui-field-box">
        <form class="layui-form" action="">
            ...
            <div class="layui-form-item">
                ...
                <!--单选框渲染控件-->
                <div  cyType="radioTool"  cyProps="codeName:'menuType',filter:'menuType'"  name="type" value="${model.type}" class="layui-input-normal"></div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">菜单名称</label>
                <div class="layui-input-normal">
                    <input type="text"  name="name" value="${model.name}" lay-verify="required" autocomplete="off" placeholder="请输入菜单名称" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-normal">
                    <input type="text"  name="url" value="${model.url}"  placeholder="请输入url" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">授权标识</label>
                <div class="layui-input-normal">
                    <input type="text"  name="perms" value="${model.perms}"  placeholder="多个用逗号分隔，如：user:list,user:create" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">排序号</label>
                <div class="layui-input-normal">
                    <input type="text"  name="order_num" value="${model.orderNum}"  placeholder="请输入排序号" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">图标</label>
                <div class="layui-input-normal">
                    <input type="text"  name="icon" value="${model.icon}"  placeholder="请输入图标" autocomplete="off" class="layui-input">
