...
<head>
    ...
    <script type="text/javascript" src="/page/area/js/list.js"></script>
</head>
<body>
<form class="layui-form " action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <button class="layui-btn search-btn" table-id="AreaTable" lay-submit="" lay-filter="search"><i class="fa fa-search">&nbsp;</i>查询
            </button>
...
<div class="layui-form ">
    <table class="layui-table" id="AreaTable" cyType="pageGrid"
           cyProps="url:'/area/list',checkbox:'true',pageColor:'#2991d9'">
        <thead>
        <tr>
            <!--复选框-->
