...
import net.dongshuai.annotation.RedisCache;
import net.dongshuai.annotation.RedisEvict;
import net.dongshuai.utils.FastJsonUtil;
...
public class RedisCacheAspect {
     ...
     */
    @Pointcut("@annotation(net.dongshuai.annotation.RedisCache)")
     ...
     */
    @Pointcut("@annotation(net.dongshuai.annotation.RedisEvict)")
